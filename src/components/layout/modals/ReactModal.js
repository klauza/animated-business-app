    ...
    <div className="container">
      ...
      <div className="row">
        <div className="col s12">
          ...
          <p className="center">React is component based javascript library for creating complex and rich UIs. React is using JSX syntax which is an XML extension to JavaScript that also comes with the full power of ES6</p>
        </div>
      </div>
      
      <p className="center"><strong>I have built few projects with React: using Redux, Context, currently trying Next.js</strong></p>
